...
.시작하기 전에
* 업그레이드하기 전에 을 참조하십시오 link:../get-started/requirements.html["구현할 수 있습니다"^] 사용자 환경이 Astra Control Center 배포에 대한 최소 요구 사항을 충족하는지 확인합니다. 환경에 다음이 있어야 합니다.
+
...
----
+
을 참조하십시오 https://["Astra Trident 문서"] 이전 버전에서 업그레이드하는 경우.
...
. 로 이동합니다 https://["Astra Control Center 제품 다운로드 페이지"^] 를 방문하십시오. 드롭다운 메뉴에서 최신 버전 또는 원하는 다른 버전을 선택할 수 있습니다.
