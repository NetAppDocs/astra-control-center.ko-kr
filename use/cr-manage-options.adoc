...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Kubernetes 사용자 지정 리소스를 사용하여 애플리케이션을 정의합니다"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["사용자 지정 리소스를 사용하여 버킷을 관리합니다"]
