...
+
** GKE 클러스터의 경우 Astra Control Service는  https://www.netapp.com/google-cloud/netapp-volumes/["Google Cloud용 NetApp Cloud Volumes Service"^] 또는 Google Persistent Disks를 영구 볼륨의 스토리지 백엔드로 사용합니다.
** AKS 클러스터의 경우 Astra Control Service는  https://www.netapp.com/azure/azure-netapp-files/["Azure NetApp Files"^] 또는 Azure 관리 디스크를 영구 볼륨의 스토리지 백엔드로 사용합니다.
