...
* https://["작업자 노드를 준비합니다"^]
* https://["Astra Trident 스토리지 백엔드를 구성합니다"^]
* https://["Astra Trident 스토리지 클래스를 구성합니다"^]
* https://["Astra Trident 볼륨 스냅샷 컨트롤러를 설치합니다"^]
* https://["볼륨 스냅샷 클래스를 생성합니다"^]
...
* https://["NetApp Support 사이트 다운로드 페이지에서 Astra Control Center를 다운로드합니다"^]
...
Astra Control Center 설정을 마친 후 다음 단계로 진행할 수 있습니다. Astra Control UI(사용자 인터페이스) 또는 를 사용할 수 있습니다 https://["Astra Control API를 참조하십시오"^].
