...
설치 지침은 를 참조하십시오 https://["OpenShift Container Platform에서 AWS에 클러스터 설치"^].
...
AWS 설명서에 따라 다음 단계를 완료하십시오. 을 참조하십시오 https://["AWS 설치 설명서"^].
...
* https://["AWS에서 Cloud Volumes ONTAP 시작하기"^].
* https://["BlueXP를 사용하여 AWS에서 커넥터를 생성합니다"^]
...
을 참조하십시오 https://["초기 GCP 자격 증명 및 권한"^].
...
BlueXP 설명서를 참조하여 다음 단계를 완료합니다. 을 참조하십시오 https://["GCP에서 Cloud Volumes ONTAP 시작하기"^].
...
.단계
. BlueXP에 자격 증명을 추가합니다. 을 참조하십시오 https://["GCP 계정 추가"^].
. GCP용 커넥터를 추가합니다.
+
.. 공급자로 "GCP"를 선택합니다.
.. GCP 자격 증명을 입력합니다. 을 참조하십시오 https://["BlueXP에서 GCP에 커넥터 생성"^].
...
* https://["Azure에 OpenShift 클러스터 설치"^].
* https://["Azure 계정을 설치하는 중입니다"^].
...
을 참조하십시오 https://["Azure 자격 증명 및 권한"^].
...
Azure 설명서에 따라 다음 단계를 완료합니다. 을 참조하십시오 https://["Azure에 OpenShift 클러스터 설치"^].
...
BlueXP 설명서를 참조하여 다음 단계를 완료합니다. 을 참조하십시오 https://["Azure에서 BlueXP를 시작합니다"^].
...
.단계
. BlueXP에 자격 증명을 추가합니다.
. Azure용 커넥터를 추가합니다. 을 참조하십시오 https://["BlueXP 정책"^].
+
.. 공급자로 * Azure * 를 선택합니다.
.. 애플리케이션 ID, 클라이언트 암호 및 디렉토리(테넌트) ID를 비롯한 Azure 자격 증명을 입력합니다.
+
을 참조하십시오 https://["BlueXPr에서 커넥터 만들기"^].
