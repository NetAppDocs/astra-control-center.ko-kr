...
Astra Trident 22.10 이상 설치 및 구성, NetApp ONTAP 버전 9.8 이상 스토리지 백엔드 [[AWS-registry]]
...
| Astra Trident(NetApp BlueXP, 이전의 Cloud Manager에서 Kubernetes 클러스터 검색의 일부로 설치됨)  a| 
Astra Trident 22.10 이상 설치 및 구성, NetApp ONTAP 버전 9.8 이상 스토리지 백엔드 [[GCP-registry]]
...
Astra Trident 22.10 이상 설치 및 구성, NetApp ONTAP 버전 9.8 이상이 스토리지 백엔드로 사용됨 [[Azure-registry]]
