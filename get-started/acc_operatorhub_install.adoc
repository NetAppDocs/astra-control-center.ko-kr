...
[role="lead"]
Red Hat OpenShift를 사용하는 경우 Red Hat 공인 운영자를 사용하여 Astra Control Center를 설치할 수 있습니다. 이 절차를 사용하여 에서 Astra Control Center를 설치합니다 https://["Red Hat 에코시스템 카탈로그"^] 또는 Red Hat OpenShift Container Platform 사용.
...
** Red Hat 에코시스템 카탈로그:
+
... NetApp Astra Control Center를 선택합니다 https://["운영자"^].
... 배포 및 사용 * 을 선택합니다.
...
.. Astra Control Center 버전을 입력합니다(예: 23.04.0-22).
