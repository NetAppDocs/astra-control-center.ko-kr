...
image:astra-architecture-diagram-v5.png["Astra Control 아키텍처 및 해당 구성 요소를 설명하는 개념적 이미지입니다"]
...
+
*** https://["Google Cloud용 NetApp Cloud Volumes Service"^] 또는 GKE 클러스터의 스토리지 백엔드로 Google 영구 디스크를 사용할 수 있습니다
*** https://["Azure NetApp Files"^] 또는 Azure 관리 디스크를 AKS 클러스터의 스토리지 백엔드로 사용합니다.
*** https://["Amazon EBS(Elastic Block Store)"^] 또는 https://["NetApp ONTAP용 Amazon FSx"^] EKS 클러스터에 대한 백엔드 스토리지 옵션으로 제공됩니다.
