...
* https://kb.netapp.com/Advice_and_Troubleshooting/Cloud_Services/Astra["* 기술 자료 * (로그인 필요)"^]Astra Control과 관련된 문서, FAQ 또는 고장 수리 정보를 검색합니다.
* * 문서 센터 *: 현재 보고 있는 문서 사이트입니다.
* https://netapppub.slack.com/#astra["Slack * 을 통해 도움을 받으십시오"^]: 동료 및 전문가와 연결하려면 thePub 작업 공간의 컨테이너 채널로 이동하십시오.
